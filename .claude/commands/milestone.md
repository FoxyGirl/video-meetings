...
3. Take the issues from the milestone "$ARGUMENTS".
4. Implement these issues, and as you implement them, make a commit according to GitFlow and close the issues, moving them to the "Done" status.
