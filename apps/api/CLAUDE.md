...
Still open (`docs/plan-meeting-file-upload-storage-and-display.md` Phase 4): `GET /meetings/:id/file` (metadata), `GET /meetings/:id/file/download`, and `DELETE /meetings/:id/file`. Read `../../docs/research-meeting-file-upload-storage-and-display.md`'s "Phase 3–4 (backend)" section for `StreamableFile` streaming and RFC 5987 filename-encoding guidance before implementing those. Remove this note once Phase 4 ships.
